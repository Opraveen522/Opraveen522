...
<%
	...
	if(totalSeat != null && date != null && destination != null && actionType.equals("search")){
		...
		<div class="ticket_info" id = 'ticket_info' >
				...
				<tr>
					<td>
						<ul>
							...
							<li><strong>From </strong> <span><%= stationFrom.name %></span></li>
							<li><strong>To </strong> <span><%= stationTo.name %></span></li>
						</ul>
					</td>
					<td>
						<ul>
							<li><strong>Bus / Number</strong> <span><%= tickDetails.get("train_name") %></span></li>
			...
			<a href="Payment.jsp" class="btn btn-success rs_search_ticket">Make Payment</a>
					<button onclick = "printDiv('ticket_info')">Print</button>
			</div>
		</div>
		<% 
		} 
